...
train_dir=os.path.join(split_dir,"train")   #所有训练数据Trian_all的80%
valid_dir=os.path.join(split_dir,"valid")   #所有训练数据Trian_all的20%
...
net.load_state_dict(torch.load('C:/Users/Aorus/.cache/torch/hub/checkpoints/vgg19-dcbb9e9d.pth'),strict=False)
